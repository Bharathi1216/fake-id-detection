...
# Function to fetch profile info using instaloader
def fetch_profile_info(username):
    ...
    try:
        ...
        features = {
            ...
            "userHasProfilPic": 1 if profile.profile_pic_url else 0,
            "userIsPrivate": 1 if profile.is_private else 0,
...
def home():
    if request.method == 'POST':
        ...
        # Get URL or username from the form
        ...
        # If profile data is unavailable, return an error
        if profile_data is None:
            return render_template("index.html", result="Invalid URL. Unable to extract profile information.")
        
        # Make prediction based on fetched profile data
...
<body>
    <div class="container">
        ...
        <form method="post">
            <input type="text" name="url" placeholder="Enter Profile URL or Username" required><br>
